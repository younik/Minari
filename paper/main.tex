...
pointmaze/umaze-v2              & 50.8  & 30.2    & 41.9   &       & 46.6 &       \\
pointmaze/medium-v2             & 40    & 33.27   & 49.5   &       & 45   & 40.1  \\
pointmaze/large-v2              & 18.9  & 24.5    & 49.5   &       & 24.1 & 24.1  \\ \midrule
pointmaze average                    &       &         &        &       &      &       \\ \midrule
antmaze/umaze-v1             & 91.3  & 42.3    & 94.6   & 68.4  &      & 84.8  \\
antmaze/umaze-diverse-v1     & 107.2 & 15.8    & 79.2   & 89.7  &      & 108.2 \\
antmaze/medium-play-v1       & 62.4  & 9.2     & 91.7   &       &      & 66.7  \\
antmaze/medium-diverse-v1    & 6.2   & 0.8     & 20.8   &       &      & 9.7   \\
antmaze/large-play-v1        &       & 12.8    & 57.2   &       &      & 45.2  \\
antmaze/large-diverse-v1     &       & 4.2     & 32.7   &       &      & 18.9  \\ \midrule
antmaze average                    &       &         &        &       &      &       \\ \midrule
pen/human-v2                 & 56.7  & 34.4    & -0.8   & 58.1  & 27.7 & 69.1  \\
pen/cloned-v2                & 41.3  & 42      & 8.2    &       & 4.29 & 51.4  \\
pen/expert-v2                & 98.5  & 53.1    & 85.1   &       & 1.5  & 101.4 \\ \midrule
door/human-v2                & 0.5   & 0.3     & 0.5    & 2.8   &      & 2.8   \\
door/cloned-v2               & 0.2   & 0.1     & 0.5    & 0.2   &      & 4.2   \\
door/expert-v2               & 102.4 & 103.5   & 0.5    & 103.6 & 89.8 & 104.2 \\ \midrule
hammer/human-v2              &       & -0.1    & 1.2    & 0.9   & 0.2  & 1.7   \\
hammer/cloned-v2             & 0.4   & 0       & 0.2    & 0.5   &      & 1.2   \\
hammer/expert-v2             & 127.9 & 109.4   & 3.1    &       & 0.2  & 130   \\ \midrule
relocate/human-v2            & -0.1  & 0.1     &        & -0.1  & 0    & -0.1  \\
relocate/cloned-v2           & 0     & 0       & 0.2    & 0     & 0.2  &       \\
relocate/expert-v2           & 103.9 & 66.6    & 0.1    & 108   & 0.2  &       \\ \bottomrule
\end{tabular}
\caption{Normalized scores of offline RL algorithms on the D4RL navigation and manipulation datasets reproduced in Minari, using the CORL~\cite{corl} implementations. Blank cells indicate runs not yet completed. \textcolor{red}{Authors: complete the empty cells and per-group averages, and state the number of seeds and the normalization convention used.}}
...
\toprule
                             & BC    & BC-10\% & TD3+BC & AWAC  & CQL  & IQL   \\ \midrule
halfcheetah/simple-v0        &       &         &        &       &      &       \\
halfcheetah/medium-v0        & 90.1  & 54.5    & 68.4   &       &      & 78.5  \\
halfcheetah/simple-replay-v0 & 4.6   & 47.1    & 47.9   &       &      & 46.9  \\
halfcheetah/medium-expert-v0 & 99.4  & 48.4    & 49.5   &       &      & 78.3  \\ \midrule
hopper/simple-v0             &       &         &        &       &      &       \\
hopper/medium-v0             & 79.5  & 83.5    & 94.5   &       &      & 80.9  \\
hopper/simple-replay-v0      & 22.9  & 83.4    & 82.9   &       &      & 75.9  \\
hopper/medium-expert-v0      & 90.4  & 104     & 71.6   &       &      & 65.8  \\ \midrule
walker2d/simple-v0           &       &         &        &       &      &       \\
walker2d/medium-v0           & 89    & 87.5    & 90.1   &       &      & 89.8  \\
walker2d/simple-replay-v0    & 23.6  & 62.8    & 71.8   &       &      &       \\
walker2d/medium-expert-v0    & 97.3  & 98.5    & 97.5   &       &      & 97.5  \\ \bottomrule
\end{tabular}
\caption{Normalized scores of offline RL algorithms on the MuJoCo locomotion datasets generated in Minari, using the CORL~\cite{corl} implementations. Blank cells indicate runs not yet completed. \textcolor{red}{Authors: complete the empty cells and per-group averages, and state the number of seeds and the normalization convention used.}}
